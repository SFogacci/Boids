...
TEST_CASE("Testing predator-boid interaction")
{
  ...
  SUBCASE("All rules")
  {
    ...
    CHECK(it->getPosition().x == doctest::Approx(103.5));
    CHECK(it->getPosition().y == doctest::Approx(100.5));
    CHECK(predator_ev.getPosition().x == doctest::Approx(104));
    CHECK(predator_ev.getPosition().y == doctest::Approx(103));
    CHECK(it->getVelocity().x == doctest::Approx(2.5));
    CHECK(it->getVelocity().y == doctest::Approx(-0.5));
